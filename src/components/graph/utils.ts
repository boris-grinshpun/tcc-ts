import { Character, CharacterAppearances, CharNameIdsHash, Graph, Episode } from '../../interfaces'
import { calcCharAppearanceInEpisodes, graphCharacters } from '../../shared-utils'

export async function prepGraphData(allCharacters: Character[], allEpisodes: Episode[]): Promise<Graph[]> {
